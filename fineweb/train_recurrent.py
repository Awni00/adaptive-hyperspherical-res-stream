...
from model_recurrent import LitRecurrentTransformerLM, get_experiment_name, parse_model_config
...
litmodel = LitRecurrentTransformerLM(model_config, train_config)#.to(device)
